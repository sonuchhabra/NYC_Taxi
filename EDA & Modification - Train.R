###
##
# Getting Envrionment Ready and Reading Data
##
###
...
local_train <- read.csv("C:/Users/sonuc/Desktop/PM Project/original/train.csv")
local_train$original <- 'Train'
str(local_train)

# storing dataframe in df, keeping local_train as backup for now
df <- local_train
# rm(local_train)
...
## -- Data Cleaning --
df <- df[(df$trip_duration == 0 & df$original == 'Test') | (df$trip_duration >= 90 & df$trip_duration <= 7200), ]
...
write.csv(df, "C:/Users/sonuc/Desktop/PM Project/Processed Train and Test/train_output.csv")
